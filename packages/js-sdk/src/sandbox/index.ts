...
export class Sandbox extends SandboxApi {
  ...
  constructor(
    ...
    const sandboxHeaders = {
      'Agentbox-Sandbox-Id': this.sandboxId,
      'Agentbox-Sandbox-Port': this.envdPort.toString(),
      ...(this.trafficAccessToken
        ? { 'Agentbox-Traffic-Access-Token': this.trafficAccessToken }
        : {}),
    }
    ...
    const rpcTransport = createConnectTransport({
      ...
      fetch: (url, options) => {
        ...
        // AgentBox endpoints are safe to use with redirect: "follow".
