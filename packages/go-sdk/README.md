...
sandbox user. Empty `User` uses the template default. The selection belongs to
each operation and works with streaming.
...
OS permission isolation. See the [filesystem guide](https://docs.agentbox.ru/en/filesystem/)
for usage examples.
