...
from agentbox import Sandbox as BaseSandbox, InvalidArgumentException
from agentbox.api.client_sync import get_transport

from agentbox_code_interpreter.constants import (
    DEFAULT_TEMPLATE,
    JUPYTER_PORT,
    DEFAULT_TIMEOUT,
)
from agentbox_code_interpreter.models import (
    ExecutionError,
    Execution,
    RunCodeLanguage,
    Context,
...
from agentbox_code_interpreter.exceptions import (
    ...
    def run_code(
        ...
        try:
            headers: Dict[str, str] = {
                ...
                "Agentbox-Sandbox-Id": self.sandbox_id,
                "Agentbox-Sandbox-Port": str(JUPYTER_PORT),
            }
            if self._envd_access_token:
                headers["X-Access-Token"] = self._envd_access_token
            if self.traffic_access_token:
                headers["Agentbox-Traffic-Access-Token"] = self.traffic_access_token
