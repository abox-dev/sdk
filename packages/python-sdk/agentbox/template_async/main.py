...
from agentbox.template.consts import GZIP, RESOLVE_SYMLINKS
from agentbox.template.logger import LogEntry, LogEntryEnd, LogEntryStart
from agentbox.template.main import TemplateBase, TemplateClass
...
from agentbox.template.utils import read_dockerignore
...
from agentbox.api.client_async import get_api_client
...
class AsyncTemplate(TemplateBase):
    ...
    async def exists(
        ...
        **opts: Unpack[ApiParams],
        ...
        return await check_alias_exists(api_client, name)
