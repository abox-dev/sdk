"""
Workload identity (iam) helpers for AgentBox sandboxes.
"""
...
def validate_iam_token_name(name: str) -> None:
    if (
        ...
        raise InvalidArgumentException(
            ...
            "'${agentbox.identity.tokens.<name>}' placeholder the egress proxy "
            "resolves."
        )
...
def iam_token_placeholder(name: str) -> str:
    ...
    return f"${{agentbox.identity.tokens.{name}}}"
