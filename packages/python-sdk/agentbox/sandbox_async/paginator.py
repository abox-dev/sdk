...
from agentbox.api.client.api.sandboxes import get_v2_sandboxes
from agentbox.api.client.api.snapshots import get_snapshots
from agentbox.api.client.types import UNSET
from agentbox.connection_config import ApiParams, ConnectionConfig, merge_api_params
...
from agentbox.api.client.models.error import Error
...
class AsyncSandboxPaginator(SandboxPaginatorBase):
    ...
    async def next_items(self, **opts: Unpack[ApiParams]) -> List[SandboxInfo]:
        ...
        :param opts: Per-call connection options (e.g. `api_key`, `domain`,
            `api_headers`, `request_timeout`). When provided, this call uses these
