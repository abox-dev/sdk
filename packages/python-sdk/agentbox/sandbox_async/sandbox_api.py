...
from agentbox.api.client.api.templates import delete_templates_template_id
...
from agentbox.sandbox_async.paginator import AsyncSandboxPaginator
        ...
        return [
            SandboxMetrics(
                ...
                timestamp=datetime.datetime.fromtimestamp(
                    metric.timestamp_unix, datetime.timezone.utc
                ),
            )
        ...
        for result in res.parsed:
            ...
            if error is not None or sandbox is None:
                if error is None:
                    ...
                    exception = SandboxException(f"{error.code}: {error.message}")
                else:
