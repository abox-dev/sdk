...
from agentbox.connection_config import ClientFactory
from agentbox.exceptions import BuildException, InvalidArgumentException
from agentbox.template.consts import RESOLVE_SYMLINKS
from agentbox.template.dockerfile_parser import parse_dockerfile
from agentbox.template.readycmd import ReadyCmd, wait_for_file
from agentbox.template.types import (
    CopyItem,
    Instruction,
    TemplateType,
    RegistryConfig,
...
from agentbox.template.utils import (
...
class TemplateBuilder:
    ...
    def set_start_cmd(
        ...
        from agentbox import wait_for_port, wait_for_url
    ...
    def set_ready_cmd(self, ready_cmd: Union[str, ReadyCmd]) -> "TemplateFinal":
        ...
        # Using ReadyCmd helpers
        from agentbox import wait_for_port, wait_for_file, wait_for_process
...
class TemplateBase(ClientFactory):
    ...
    def __init__(
        ...
        """
        self._default_base_image: str = (
            "docker.io/retailcrm/agentbox-base:v0.0.1@sha256:"
            "493b753044eb82f90b99afb3974033591ccbd7037b39e7963dfe49f38790376e"
        )
