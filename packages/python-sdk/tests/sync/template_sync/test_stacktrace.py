...
from agentbox import Template, CopyItem, wait_for_timeout
from agentbox.template.types import TemplateBuildStatus
import agentbox.template_sync.main as template_sync_main
import agentbox.template_sync.build_api as build_api_mod
...
def test_traces_on_from_image(build):
    template = Template()
    template = template.from_image("agentbox.dev/this-image-does-not-exist")
