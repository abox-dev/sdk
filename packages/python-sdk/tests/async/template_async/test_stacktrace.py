...
from agentbox import AsyncTemplate, CopyItem, wait_for_timeout
from agentbox.template.types import TemplateBuildStatus
import agentbox.template_async.main as template_async_main
import agentbox.template_async.build_api as build_api_mod
...
async def test_traces_on_from_image(async_build):
    template = AsyncTemplate().from_image("agentbox.dev/this-image-does-not-exist")
