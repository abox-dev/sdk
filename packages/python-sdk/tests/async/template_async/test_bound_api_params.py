...
import agentbox.template_async.main as template_async_main
from agentbox import AsyncTemplate, Template, TemplateTagInfo
from agentbox.connection_config import ApiParams
from agentbox.template.types import BuildInfo

BOUND_API_KEY = "ab_" + "1" * 40
...
async def test_top_level_template_falls_back_to_env(configs, monkeypatch, test_api_key):
    monkeypatch.setenv("AGENTBOX_API_KEY", test_api_key)
    monkeypatch.setenv("AGENTBOX_DOMAIN", "env.example.com")
