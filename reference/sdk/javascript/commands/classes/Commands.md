[@abox-dev/sdk](../README.md) / Commands
...
[`CommandRequestOpts`](../interfaces/CommandRequestOpts.md)
...
> **connect**(`pid`, `opts?`): `Promise`\<`CommandHandle`\>
...
> **list**(`opts?`): `Promise`\<[`ProcessInfo`](../interfaces/ProcessInfo.md)[]\>
...
> **run**(`cmd`, `opts?`): `Promise`\<`CommandResult`\>
...
[`CommandStartOpts`](../interfaces/CommandStartOpts.md) & `object`
...
> **run**(`cmd`, `opts`): `Promise`\<`CommandHandle`\>
...
> **run**(`cmd`, `opts?`): `Promise`\<`CommandResult` \| `CommandHandle`\>
