[@abox-dev/sdk](../../README.md) / [sandboxApi](../README.md) / SnapshotPaginator
...
- `Paginator`\<[`SnapshotInfo`](../interfaces/SnapshotInfo.md), [`SandboxApiOpts`](../interfaces/SandboxApiOpts.md)\>

## Constructors

### Constructor

> **new SnapshotPaginator**(`opts?`): `SnapshotPaginator`
...
`Paginator<SnapshotInfo, SandboxApiOpts>.constructor`
...
> **nextItems**(`opts?`): `Promise`\<[`SnapshotInfo`](../interfaces/SnapshotInfo.md)[]\>
