[@abox-dev/code-interpreter](../../README.md) / [sandbox](../README.md) / Sandbox
...
`BaseSandbox.defaultMcpTemplate`
...
`BaseSandbox.defaultSandboxTimeoutMs`

***

### defaultTemplate

> `protected` `readonly` `static` **defaultTemplate**: `string` = `'code-interpreter-v1'`

#### Overrides

`BaseSandbox.defaultTemplate`
...
> **get** `protected` **jupyterUrl**(): `string`
...
> **runCode**(`code`, `opts?`): `Promise`\<[`Execution`](../../messaging/classes/Execution.md)\>
...
`Promise`\<[`Execution`](../../messaging/classes/Execution.md)\>
