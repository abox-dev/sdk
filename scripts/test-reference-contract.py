...
def main() -> None:
    ...
    assert manifest["packages"]["github.com/abox-dev/sdk/packages/go-sdk"] == re.search(
        r'^const Version = "([^"]+)"',
    ...
    go_core = (REFERENCE / "sdk/go/core.md").read_text()
    go_code_interpreter = (REFERENCE / "sdk/go/code-interpreter.md").read_text()
    for rendered, package, signatures in (
        (
            go_core,
            'import "github.com/abox-dev/sdk/packages/go-sdk"',
            ("func NewClient", "type Sandbox", "Start(ctx context.Context"),
        ),
        (
            go_code_interpreter,
            'import "github.com/abox-dev/sdk/packages/go-sdk/codeinterpreter"',
            ("func NewClient", "type Execution", "RunCode(ctx context.Context"),
        ),
    ):
        assert rendered.startswith("<!-- Code generated by gomarkdoc. DO NOT EDIT -->")
        assert package in rendered
        assert "blob/main" not in rendered
        assert "github.com/abox-dev/sdk/blob/" not in rendered
        assert "](<#" in rendered
